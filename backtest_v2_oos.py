# -*- coding: utf-8 -*-
"""
回測 v2 OOS (Out-of-Sample)：2018-2022 完全沒看過的資料
═════════════════════════════════════════════════
策略與 v2 真版完全相同（不調任何參數）
回測期間：2018-01 ~ 2022-12 (5 年)

包含 4 個壓力測試場景：
  ⚡ 2018-Q4：Fed 升息 + 美中貿易戰，台股 -15%
  ⚡ 2020-03：COVID 崩盤（2 週 -30%）
  ⚡ 2020-Q2~2021：QE 推升超級多頭
  ⚡ 2022-01~10：升息熊（台股 -28%）
  ⚡ 2022-Q4：反彈
...
def main():
    ...
    # OOS: 改 bs 區間抓 2016-2022 資料（含 ATH 暖機）
    bs.START_DATE = "2016-01-01"
    ...
    out = {"final_cash": cash, "trades": trades, "n_trades": n,
           "version": "v2 OOS (2018-2022 out-of-sample)",
           "params": {
           ...
           "daily_top_industries": daily_top_inds[-30:],
           }
    with open("backtest_v2_oos.json", "w", encoding="utf-8") as f:
        json.dump(out, f, ensure_ascii=False, indent=2, default=str)
    print("\n💾 已輸出 backtest_v2_oos.json")
